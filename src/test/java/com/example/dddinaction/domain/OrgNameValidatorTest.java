...
public class OrgNameValidatorTest {
    ...
    public void should_throw_exception_when_org_name_is_empty_or_null() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> orgNameValidator.verify(createOrgRequest));
    ...
    public void should_throw_exception_when__org_name_has_been_duplicated_with_same_superior() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> orgNameValidator.verify(request));
